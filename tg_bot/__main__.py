...
def send_start(bot, update):
    ...
    keyboard = [[
        InlineKeyboardButton(text=tld(chat.id, '🥳Add HERMOINE To Group'),
                             url="https://t.me/hermoinegranger_bot?startgroup=true"), InlineKeyboardButton(text="❓ Help", callback_data="help_back")
        ]]
    keyboard += [[
        InlineKeyboardButton(text=tld(chat.id, '👥 Support Group'), url="https://t.me/logangiveaways")
    ]]
